...
import lk.ijse.policeStation.Bo.Custom.Impl.VehicleBoImpl;
...
public class ManageVehicleFormController {
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateVehicle()) {
            ...
            try {
                boolean isSuccess = vehicleBo.saveVehicle(vehicleDto);
                if (isSuccess) {
    ...
    void BtnSearchOnAction(ActionEvent event) {
        ...
        try {
            Optional<VehicleDto> vehicleDto = vehicleBo.searchVehicle(code);
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateVehicle()) {
            ...
            try {
                boolean isUpdated = vehicleBo.updateVehicle(updatedVehicleDto);
