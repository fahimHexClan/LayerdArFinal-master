...
import lk.ijse.policeStation.Bo.Custom.Impl.CrimeBoIml;
...
public class ManageCrimeFormController {
    ...
    CrimeBo crimeBo =new CrimeBoIml();
    ...
    void BtnDeleteOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        if (pressedButton.equals(ButtonType.YES)) {
            boolean isDeleted = crimeBo.deleteCrime(id);
            if (isDeleted) {
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateCrime()) {
            ...
            try {
                boolean isSuccess = crimeBo.saveCrime(crimeDto);
                if (isSuccess) {
    ...
    private void setTable() {
        try {
            ...
            ArrayList<CrimeDto> allCrimes = crimeBo.getAllCrimes();
    ...
    void BtnSearchOnAction(ActionEvent event) {
        ...
        try {
            Optional<CrimeDto> Crime = crimeBo.searchCrime(code);
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateCrime()) {
            ...
            try {
                boolean isUpdated = crimeBo.updateCrime(updatedCrimeDto);
