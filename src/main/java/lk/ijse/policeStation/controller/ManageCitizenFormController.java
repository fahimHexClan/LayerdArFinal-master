...
import lk.ijse.policeStation.Bo.Custom.Impl.CitizenBoImpl;
...
public class ManageCitizenFormController {
    ...
    CitizenBo citizenBo = new CitizenBoImpl();
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateCitizen()) {
            ...
            try {
                boolean isSuccess = citizenBo.saveCitizen(citizenDto);
                if (isSuccess) {
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        ...
        if (pressedButton.equals(ButtonType.YES)) {
            try {
                boolean isDeleted = citizenBo.deleteCitizen(id);
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateCitizen()) {
            ...
            try {
                boolean isUpdated = citizenBo.updateCitizen(updatedCitizenDto);
    ...
    public void BtnSearchOnAction(ActionEvent actionEvent) {
        ...
        try {
            Optional<CitizenDto> citizen = citizenBo.findCitizen(code);
    ...
    public void setTable() {
        try {
            List<CitizenDto> allCitizens = citizenBo.getAllCitizens();
            List<CitizenTm> citizen = new ArrayList<>();
        ...
        /* try {
            ArrayList<CitizenDto> allCitizens = citizenBo.getAllCitizens();
