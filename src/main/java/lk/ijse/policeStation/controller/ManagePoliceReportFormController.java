...
import lk.ijse.policeStation.Bo.Custom.Impl.PoliceReportBoImpl;
...
import lk.ijse.policeStation.Dao.custom.Impl.UserDaoImpl;
...
public class ManagePoliceReportFormController {
    ...
    PoliceReportBo policeReportBo =new PoliceReportBoImpl();
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            ArrayList<String> userIds = userDao.loadUserIds();
    ...
    private ArrayList<String> loadCitizenIds() throws SQLException, ClassNotFoundException {
        ArrayList<Citizen> citizenList = new CitizenDaoImpl().getAllCitizens();
    ...
    public void BtnSearchOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        Optional<PoliceReportDto> PoliceReport = policeReportBo.searchPoliceReport(code);
    ...
    public void BtnSaveOnAction(ActionEvent actionEvent) {
        if (validatePoliceReport()) {
            ...
            try {
                boolean isSuccess = policeReportBo.savePoliceReport(policeReportDto);
                if (isSuccess) {
    ...
    private void setTable() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<PoliceReportDto> allReports = policeReportBo.getAllReports();
    ...
    public void BtnUpdateOnAction(ActionEvent actionEvent) {
        if (validatePoliceReport()) {
            ...
            try {
                boolean isUpdated = policeReportBo.updatePoliceReport(updatedPoliceReportDto);
    ...
    public void BtnDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (pressedButton.equals(ButtonType.YES)) {
            try {
                boolean isDeleted = policeReportBo.deletePoliceReport(id);
                if (isDeleted) {
