...
public class ManageDriverFormController {
    ...
    private void visualize() {
        ...
        ClmFinesStatus.setCellValueFactory(new PropertyValueFactory<>("FinesStatus"));
    ...
    private void setTable() throws SQLException, ClassNotFoundException {
        ...
        for (DriverDto driver : allDrivers) {
            ...
            driverTm.setFinesStatus(driver.getFinesStatus());
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateDriver()) {
            ...
            try {
                boolean isSuccess = driverBo.saveDriver(driverDto);
                if (isSuccess) {
    ...
    void BtnSearchOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        Optional<DriverDto> driver = driverBo.searchDriver(code);
        if (driver.isPresent()) {
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateDriver()) {
            ...
            try {
                boolean isUpdated = driverBo.updateDriver(updatedDriver);
                if (isUpdated) {
