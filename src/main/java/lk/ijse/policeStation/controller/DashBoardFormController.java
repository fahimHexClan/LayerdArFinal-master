...
import lk.ijse.policeStation.Dao.custom.Impl.*;
...
public class DashBoardFormController {
    ...
    PoliceReportDaoImpl policeReportDao=new PoliceReportDaoImpl();
    ...
    private void updateComplaintDetailsChart() {
        try {
            Map<String, Integer> complaintDetails = complaintDao.getComplaintDetails();
    ...
    private void updateNumberOfCrimes() {
        try {
            int numberOfCrimes = crimeDao.getAllCrimes().size();
    ...
    private void updateNumberOfFines() {
        try {
            FinesDaoImpl finesDao=new FinesDaoImpl();
            int numberOfFines = finesDao.getAllFines().size();
    ...
    private void updateNumberOfEmployees() {
        try {
            int numberOfEmployees = employeesDao.getAllEmployees().size();
    ...
    private void updateNumberOfCitizens() {
        try {
            int numberOfCitizens = new CitizenDaoImpl().getAllCitizens().size();
    ...
    private void updateNumberOfComplaints() {
        try {
            int numberOfComplaints = complaintDao.getComplaintDetails().size();
    ...
    private void updateNumberOfReports() {
        try {
            int numberOfReports = policeReportDao.getAllReports().size();
