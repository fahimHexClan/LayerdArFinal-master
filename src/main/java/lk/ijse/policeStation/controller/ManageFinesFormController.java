...
import lk.ijse.policeStation.Bo.Custom.Impl.DriverBoImpl;
import lk.ijse.policeStation.Bo.Custom.Impl.FinesBoImpl;
import lk.ijse.policeStation.Bo.Custom.Impl.FinesBoTransectionImpl;
...
public class ManageFinesFormController {
    ...
    void BtnSaveOnAction(ActionEvent event) throws SQLException {
        FinesBoTransectionImpl placeOrderBo = new FinesBoTransectionImpl();
        String driveId= CmbDriverId.getSelectionModel().getSelectedItem();
        placeOrderBo.PlaceOrder(CollectFines(),driveId,this);
        /*
        if (validateFines()) {
    ...
    public void setTable() throws SQLException, ClassNotFoundException {
        ArrayList<FinesDto> finesList = finesBo.getAllFines();
    ...
    void BtnSearchOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        Optional<FinesDto> fines = finesBo.searchFines(code);
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateFines()) {
            ...
            try {
                boolean isUpdated = finesBo.updateFines(updatedFines);

                if (isUpdated) {
                    boolean isDriverStatusUpdated = driverBo.updateStatus(updatedFines, CmbDriverId.getValue());
